...
import createOrderedLiteral, {
  setOrder,
} from '@stoplight/ordered-object-literal';
...
const PATCHED_FUNCTIONS = ['markdownTemplate'];
...
function max(
  left: DiagnosticSeverity | string,
  right: DiagnosticSeverity | string,
...
function getDiagnosticSeverity(
  ...
  return Number.isNaN(Number(severity))
